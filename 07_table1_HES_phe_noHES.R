...
df_sex_2 <- arrange(df_sex_2, hes_record, sex, age_band_23_01_2020)
...
write.csv(df_sex_2, 'results/v200/table1/pop_sex_age_HES_phe_noHES.csv', row.names = FALSE)
...
write.csv(df_imd, 'results/v200/table1/pop_imd_HES_phe_noHES.csv', row.names = FALSE)
...
write.csv(df_ethn_11, 'results/v200/table1/pop_ethn_11_HES_phe_noHES.csv', row.names = FALSE)
...
write.csv(df_ethn_5, 'results/v200/table1/pop_ethn_5_HES_phe_noHES.csv', row.names = FALSE)
...
write.csv(df_cov, 'results/v200/table1/pop_cov_HES_phe_noHES.csv', row.names = FALSE)
...
write.csv(df_cov_3, 'results/v200/table1/pop_cov_HES_phe_noHES.csv', row.names = FALSE)
...
write.csv(df_death, 'results/v200/table1/pop_death_HES_phe_noHES.csv', row.names = FALSE)
